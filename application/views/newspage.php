<?php include("header.php"); ?>
            ...
            <div class="list-can">
                ...
                <div class="article-list">
                    ...
                    <div class="article">
                        <div class="hd">
                            <h3><?php echo $newspage->title;?></h3>
                            <div class="article-info">
                                <span>来源：<?php echo $newspage->source;?></span>
                                <span>时间：<?php echo $newspage->addTime;?></span>
                                <span>点击次数：<?php echo $newspage->clickCount;?></span>
                            </div>
                        </div>
                        <div class="article-main row">
                            <?php echo $newspage->content;?>
                        </div>
                    </div>
                </div>
            </div>
