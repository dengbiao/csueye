                ...
                <div class="article-list">
                    ...
                    <ul>
                        ...
                        <li class="list-entry">                        
                            ...
                            <div class="details">
                                <a href="<?php echo site_url('/newspage/view').'/'.$value['id'];?>" class="overview"><?php echo ellipsize($value['content'],64,5);?> <span>[查看详情]</span></a>
                                <p class="detail-entry">来源：<?php echo $value['source'];?></p>
