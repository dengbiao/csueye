		...
		<div id="content">
			...
			<div id="right">
				<div class="box">
					...
					<form id="articleForm" name="articleForm" action="<?php echo site_url('admin/keytime/keytimeModify')?>" method="post">
					<input type="hidden" name="id" value="<?php echo $keytime->id;?>">
					<div>
						<center>
							<div>事件时间：<input name="time" id="timeChooser" value="<?php echo $keytime->time; ?>" style="width:300px;height:20px" /></div><br/>
								<p>事件内容：<input name="event" value="<?php echo $keytime->event;?>" style="width:300px;height:20px" />	</p>
							</div><br/>
